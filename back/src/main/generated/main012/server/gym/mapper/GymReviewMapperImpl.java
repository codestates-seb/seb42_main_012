...
import main012.server.gym.dto.GymReviewDto.ReviewInfo;
import main012.server.gym.entity.GymReview;
import org.springframework.stereotype.Component;

@Generated(
    value = "org.mapstruct.ap.MappingProcessor",
    date = "2023-03-29T01:30:34+0900",
...
public class GymReviewMapperImpl implements GymReviewMapper {
    ...
    @Override
    public List<ReviewInfo> gymReviewsToGymReviewInfoDtos(List<GymReview> gymReviews) {
        if ( gymReviews == null ) {
            return null;
        }

        List<ReviewInfo> list = new ArrayList<ReviewInfo>( gymReviews.size() );
        for ( GymReview gymReview : gymReviews ) {
            list.add( gymReviewToGymReviewInfoDto( gymReview ) );
        }
